...
class Achievements {
	public static var achievementShits:Array<Dynamic> = [//Name, Description, Achievement save tag, Unlocks after, Hidden achievement
		...
		//["Unlocked Pico!",		"Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			'week1', 		true],
	];
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		achievementName.setFormat(Paths.font("bauhaus-heavy-bt.ttf"), 16, FlxColor.WHITE, LEFT);
