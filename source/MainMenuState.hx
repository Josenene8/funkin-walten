...
class MainMenuState extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['story_mode','freeplay', 'donate', 'credits', 'options'];
	...
	override function create()
	{
		...
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "THIS MOD CONTAINS CONTENT THAT MAY SEEM DISTURBING TO SOME PLAYERS.");
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
