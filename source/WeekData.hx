...
typedef WeekFile =
{
	...
	var hideFreeplayPico:Bool;
	var hideSecretSongs:Bool;
...
class WeekData {
	...
	public var hideFreeplayPico:Bool;
	public var hideSecretSongs:Bool;
	...
	public static function createWeekFile():WeekFile {
		var weekFile:WeekFile = {
			...
			hideStoryMode: false,
			hideFreeplay: false,
			hideFreeplayPico: false,
			hideSecretSongs: false,
			difficulties: ''
		};
		return weekFile;
	}
	...
	public function new(weekFile:WeekFile) {
		...
		hideFreeplayPico = weekFile.hideFreeplayPico;
		hideSecretSongs = weekFile.hideSecretSongs;
			...
			for (j in 0...directories.length) {
				...
				if(!weeksLoaded.exists(sexList[i])) {
					...
					if(week != null) {
						...
						if(weekFile != null && (isStoryMode == null || (isStoryMode && !weekFile.hideStoryMode) || (!isStoryMode && !weekFile.hideFreeplay) || (!isStoryMode && !weekFile.hideFreeplayPico) || (!isStoryMode && !weekFile.hideSecretSongs))) {
	...
	private static function addWeek(weekToCheck:String, path:String, directory:String, i:Int, originalLength:Int)
	{
		if(!weeksLoaded.exists(weekToCheck))
		{
			...
			if(week != null)
			{
				...
				if((PlayState.isStoryMode && !weekFile.hideStoryMode) || (!PlayState.isStoryMode && !weekFile.hideFreeplay) || (!PlayState.isStoryMode && !weekFile.hideFreeplayPico) || (!PlayState.isStoryMode && !weekFile.hideSecretSongs))
				{
